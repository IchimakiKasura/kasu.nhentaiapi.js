...
class main {
    ...
    */
    ...
    async pRandTag(string, data){
        await this.pRand(string, data, "pRandTag", "tag")
    };
    async pRandParody(string, data){
        await this.pRand(string, data, "pRandParody", "parody")
    };
    async pRandArtist(string, data){
        await this.pRand(string, data, "pRandArtist", "artist")
    };
    async pRandGroup(string, data){
        await this.pRand(string, data, "pRandGroup", "group")
    };
