...
class Main {
    ...
    async #pRandDataGiver($, string, data, isError, tag, isSpecific){
        ...
        try {
            ...
            /*********/
            /***/debugIteration("[KASUAPI.JS] took to iterate: ",performance.now() - start)
            /*********/
            ...
            if(this.ReRollonFail && !/DISCORD ToS: REROLL DENIED/.test(e)){
                /*********/
                /***/debugIteration("[KASUAPI.JS | REROLL] took to iterate: ",performance.now() - start)
                /*********/
                return this.#pRandDataGiver($, string, data, isError, tag, isSpecific);
            }
            throw e
        }
    }
