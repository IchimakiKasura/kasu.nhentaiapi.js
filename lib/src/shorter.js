...
async function shorter(code,discordToS) {
   ...
   if(discordToS) {
        if(/lolicon|shotacon|beastiality|torture|minigirl|blood|guro|cannibalism|shota|loli/ig.test(tags)){
            return console.error("DISCORD ToS: The doujin picked has a Tag that isn't allowed on Discord") 
        } 
    }
